...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="Loved by thousands of designers" text3="See how we're making a difference in creative workflows and productivity for creative professionals worldwide" />
