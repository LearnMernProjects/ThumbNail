...
export default function HeroSection() {
    const specialFeatures = [
        ...
        "Lightning speed Generation",
        "High quality results",
    ];
const navigate = useNavigate();
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            <div className="absolute top-30 -z-10 left-1/4 size-72 bg-green-600 blur-[300px]"></div>
            <motion.a href="https://prebuiltui.com?utm_source=pixels" className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-green-100 bg-green-200/15"
            ...
            >
                AI Thumbnail for your videos <span className="move-gradient px-3 rounded-xl text-nowrap">Next.js site.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                No complexity. No noise. Just clean, reliable design thumbnails for your videos.</motion.p>
            ...
            >
                <button onClick={() => navigate('/generate')} className="bg-green-600 hover:bg-green-700 text-white rounded-full px-7 h-11">
                    Generate Now
                </button>
