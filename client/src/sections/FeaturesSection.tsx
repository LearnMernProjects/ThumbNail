...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="What to use our generator?" text3="Chaos free Thumbnail Generation in just few seconds" />
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature: IFeature, index: number) => (
                    <motion.div key={index} className={`${index === 1 ? 'p-px rounded-[13px] bg-linear-to-br from-green-600 to-slate-800' : ''}`}
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                <div className="absolute -z-50 size-100 -top-10 -left-20 aspect-square rounded-full bg-green-500/40 blur-3xl"></div>
                ...
                >
                    Our platform offers powerful features to elevate your nail art designs.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Better builds from AI and real-time revenue insights for maximum profitability and customer satisfaction, all in one platform.</p>
                        <a href="https://prebuiltui.com" className="group flex items-center gap-2 mt-4 text-green-600 hover:text-green-700 transition">
                            Start generating now for free
