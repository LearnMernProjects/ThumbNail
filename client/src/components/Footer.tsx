...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to="/">
                    <img className = "size-8 aspect square" src="/favicon.svg" width={32} height={32} />
                </Link>
                    ...
                    <div key={index}>
                        ...
                        <ul className="mt-2 space-y-2">
                            {section.links.map((link: IFooterLink, index: number) => (
                                <li key={index}>
                                    <Link to={link.href} className="hover:text-green-600 transition">
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    <a href="https://dribbble.com/prebuiltui" target="_blank" rel="noreferrer">
                        <DribbbleIcon className="size-5 hover:text-green-500" />
                    </a>
                    <a href="https://www.linkedin.com/company/prebuiltui" target="_blank" rel="noreferrer">
                        <LinkedinIcon className="size-5 hover:text-green-500" />
                    </a>
                    <a href="https://x.com/prebuiltui" target="_blank" rel="noreferrer">
                        <TwitterIcon className="size-5 hover:text-green-500" />
                    </a>
                    <a href="https://www.youtube.com/@prebuiltui" target="_blank" rel="noreferrer">
                        <YoutubeIcon className="size-6 hover:text-green-500" />
                    </a>
                </div>
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">NailThumbnail </a></p>
            </motion.div>
        </footer>
    );
}